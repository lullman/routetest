...
Movie.create(movie_title: "A New Hope", released: 1976)
Movie.create(movie_title: "The Empire Strikes Back", released: 1979)
...
Movie.create(movie_title: "Rogue One", released: 2016)
